...
@Component({
  selector: 'app-aperitivo-one',
  templateUrl: './aperitivo-one.component.html',
  styleUrls: ['./aperitivo-one.component.css']
})
export class AperitivoOneComponent {
  constructor(private  http: HttpClient, private router: Router) {
    this.titulo = 'Joelho Eats'; // Inicialização da propriedade 'titulo' no construtor
    this.descricao = 'Joelho mas não é de verdade'; // Inicialização da propriedade 'descricao' no construtor
